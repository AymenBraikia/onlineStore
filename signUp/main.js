...
document.querySelector(".input.usernameInput").onkeypress = k => {
    if (k.code == "Enter") document.querySelector(".input.emailInput").focus()
}
document.querySelector(".input.emailInput").onkeypress = k => {
