...
} else document.querySelector(".extra.ctr").removeChild(document.querySelector(".account"));
...
document.onscroll = e => {
    if (scrollY >= ((20 * innerHeight) / 100)) document.querySelector(".sections").style.cssText = "position: fixed; top:0;";
    else document.querySelector(".sections").style.cssText = "";
    if (scrollY >= 500) document.querySelector(".scrollUp").style.cssText = "opacity: 1;";
